    ...
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
      ...
      <nav>
        <ul class="flex space-x-6">
          ...
          <li><a href="#FeaturedCupcakes" class="text-gray-700 hover:text-pink-500">Shop</a></li>
          <li><a href="#AboutUs" class="text-gray-700 hover:text-pink-500">About</a></li>
          <li><a href="#Occasions" class="text-gray-700 hover:text-pink-500">Special Occasions</a></li>
        </ul>
      </nav>
