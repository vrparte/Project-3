  ...
  <div class="container mx-auto px-4 py-4 flex justify-between items-center">
    ...
    <nav>
      <ul class="flex space-x-6">
        <li><Link to="/" class="text-gray-700 hover:text-pink-500 text-lg font-semibold">Home</Link></li>
        <li><a href="#FeaturedCupcakes" on:click={(e) => handleNavigation(e, 'FeaturedCupcakes')} class="text-gray-700 hover:text-pink-500 text-lg font-semibold">Shop</a></li>
        <li><a href="#AboutUs" on:click={(e) => handleNavigation(e, 'AboutUs')} class="text-gray-700 hover:text-pink-500 text-lg font-semibold">About</a></li>
        <li><a href="#Occasions" on:click={(e) => handleNavigation(e, 'Occasions')} class="text-gray-700 hover:text-pink-500 text-lg font-semibold">Special Occasions</a></li>
      </ul>
    </nav>
